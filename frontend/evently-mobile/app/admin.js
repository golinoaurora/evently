...
const styles = StyleSheet.create({
  ...
  adminBadge: { flexDirection: "row", alignItems: "center", gap: 6, borderWidth: 1, borderColor: "#FF1493", borderRadius: 100, paddingVertical: 5, paddingHorizontal: 12 },
  adminBadgeText: { color: "#FF1493", fontSize: 9, letterSpacing: 3 },
  ...
  messaggioBox: { backgroundColor: "#0f0f0f", borderRadius: 8, padding: 12, marginTop: 8, borderLeftWidth: 2, borderLeftColor: "#FF1493" },
