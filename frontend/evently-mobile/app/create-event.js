...
const styles = StyleSheet.create({
  ...
  label: { color: "#555", fontSize: 10, letterSpacing: 4, marginBottom: 8, marginTop: 16, fontWeight: "600" },
  input: { borderBottomWidth: 1, borderBottomColor: "#222", color: "#fff", fontSize: 15, fontWeight: "300", paddingVertical: 12 },
  inputMultiline: { borderWidth: 1, borderColor: "#222", padding: 12, height: 100, textAlignVertical: "top", marginTop: 8, borderRadius: 8 },
  dataBtn: { borderBottomWidth: 1, borderBottomColor: "#222", paddingVertical: 12, flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  dataBtnText: { color: "#fff", fontSize: 14, fontWeight: "300" },
  dataIcon: { fontSize: 16 },
  catGradient: { paddingVertical: 8, paddingHorizontal: 18, borderRadius: 100 },
  catDefault: { paddingVertical: 8, paddingHorizontal: 18, borderRadius: 100, borderWidth: 1, borderColor: "#222" },
  catText: { color: "#555", fontSize: 10, letterSpacing: 2, fontWeight: "600" },
  catTextActive: { color: "#fff", fontSize: 10, letterSpacing: 2, fontWeight: "800" },
  pickerBtn: { borderWidth: 1, borderColor: "#222", padding: 14, flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 8, borderRadius: 8 },
  pickerBtnText: { color: "#fff", fontSize: 14, fontWeight: "300" },
  pickerArrow: { color: "#FF1493", fontSize: 12 },
  pickerDropdown: { borderWidth: 1, borderColor: "#222", borderTopWidth: 0, backgroundColor: "#0a0a0a", maxHeight: 200 },
  pickerSearch: { borderBottomWidth: 1, borderBottomColor: "#222", color: "#fff", padding: 12, fontSize: 13 },
  ...
  urlSuggerimento: { color: "#555", fontSize: 10, marginTop: 6, lineHeight: 16 },
  ...
  button: { borderRadius: 16, overflow: "hidden", marginTop: 36, marginBottom: 24, shadowColor: "#FF1493", shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.4, shadowRadius: 16, elevation: 10 },
  buttonGradient: { padding: 20, alignItems: "center" },
  buttonText: { color: "#fff", fontSize: 14, fontWeight: "800", letterSpacing: 4 },
});