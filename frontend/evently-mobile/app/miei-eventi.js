...
const styles = StyleSheet.create({
  ...
  glowGreen: { position: "absolute", top: -60, left: -40, width: 180, height: 180, borderRadius: 90, backgroundColor: "rgba(57,255,110,0.06)" },
  ...
  cardMese: { color: "#39FF6E", fontSize: 9, letterSpacing: 2, fontWeight: "600" },
  ...
  cardOra: { color: "#333", fontSize: 10 },
  cardDescrizione: { color: "#444", fontSize: 10, flex: 1 },
