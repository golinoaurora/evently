...
const styles = StyleSheet.create({
  ...
  glowBlue: { position: "absolute", bottom: 100, left: -60, width: 160, height: 160, borderRadius: 80, backgroundColor: "rgba(30,80,255,0.12)" },
  ...
  colorLines: { flexDirection: "column", gap: 4, marginBottom: 20 },
  colorLine: { height: 2, borderRadius: 1 },
  subtitle: { color: "#555", fontSize: 10, letterSpacing: 5, marginBottom: 10, fontWeight: "600" },
  descrizioneText: { color: "#777", fontSize: 14, lineHeight: 22 },
  inputGroup: { marginBottom: 24 },
  label: { color: "#555", fontSize: 10, letterSpacing: 4, marginBottom: 10, fontWeight: "600" },
  inputWrapper: { borderBottomWidth: 1, borderBottomColor: "#222" },
  input: { color: "#fff", fontSize: 15, fontWeight: "300", paddingVertical: 12 },
  inputAccent: { height: 2, width: 36, backgroundColor: "#FF1493", marginTop: -1 },
  inputMultiline: { borderWidth: 1, borderColor: "#222", borderRadius: 12, padding: 14, height: 110, textAlignVertical: "top", marginTop: 8 },
  error: { color: "#FF1493", fontSize: 12, textAlign: "center", marginTop: 16 },
  button: { borderRadius: 16, overflow: "hidden", marginTop: 36, shadowColor: "#FF1493", shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.4, shadowRadius: 16, elevation: 10 },
